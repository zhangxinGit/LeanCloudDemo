...
+ (NSDictionary*)deviceNamesByCode
{
    ...
    dispatch_once(&onceToken, ^{
        deviceNamesByCode = @{
                              ...
                              @"iPod1,1" :[NSNumber numberWithInteger:iPod],
                              @"iPod2,1" :[NSNumber numberWithInteger:iPod],
                              @"iPod3,1" :[NSNumber numberWithInteger:iPod],
                              @"iPod4,1" :[NSNumber numberWithInteger:iPod],
                              @"iPod5,1" :[NSNumber numberWithInteger:iPod],
